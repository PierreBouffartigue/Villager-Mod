 ...
 */
public class ModelCweep extends ModelBase {
    ...
    public ModelCweep() {
        ...
        this.field_78150_a2.setRotationPoint(0.0F, 15.0F, -8.0F);
        this.field_78150_a2.addBox(4.0F, -5.0F, -4.0F, 1, 3, 1, 0.0F);
        this.field_78144_f = new ModelRenderer(this, 0, 16);
        this.field_78144_f.setRotationPoint(4.0F, 11.3F, -6.0F);
        this.field_78144_f.addBox(-2.0F, 0.0F, -2.0F, 4, 8, 4, 0.0F);
        ...
        this.setRotateAngle(field_78148_b0, 0.39269908169872414F, 0.0F, 0.0F);
        this.field_78147_e = new ModelRenderer(this, 0, 16);
        this.field_78147_e.setRotationPoint(-4.0F, 11.3F, -6.0F);
        this.field_78147_e.addBox(-2.0F, 0.0F, -2.0F, 4, 9, 4, 0.0F);
        this.field_78149_c = new ModelRenderer(this, 0, 16);
        this.field_78149_c.setRotationPoint(-4.0F, 11.2F, 7.0F);
        this.field_78149_c.addBox(-2.0F, 0.0F, -2.0F, 4, 9, 4, 0.0F);
        this.field_78150_a0 = new ModelRenderer(this, 0, 0);
        this.field_78150_a0.setRotationPoint(0.0F, 10.1F, -8.0F);
        ...
        this.setRotateAngle(field_78148_b1, 0.39269908169872414F, 0.0F, 0.0F);
        this.field_78150_a1 = new ModelRenderer(this, 22, 0);
        this.field_78150_a1.setRotationPoint(0.0F, 15.0F, -8.0F);
        this.field_78150_a1.addBox(-5.0F, -5.0F, -4.0F, 1, 3, 1, 0.0F);
        this.field_78146_d = new ModelRenderer(this, 0, 16);
        this.field_78146_d.setRotationPoint(4.0F, 11.4F, 7.0F);
        this.field_78146_d.addBox(-2.0F, 0.0F, -2.0F, 4, 9, 4, 0.0F);
    }
